    ...
    <>
      <nav className="flex w-full py-6 px-2 justify-around items-center border-b-[1px] border-b-slate-100 ">
        <div className="hidden md:flex md:gap-6">
          ...
          <NavLink className="font-extrabold text-sm  font-urbanist hover-underline">
            ABOUT
          </NavLink>
        </div>
        <div
          className="md:hidden w-5 h-4 transition-all flex flex-col  justify-between"
          onClick={openSuperNav}
        >
          <span
            className={`w-full h-[2px] bg-black  rounded-sm transition-all ${
        ...
        <Link to="/">
          <svg
            ...
            alt="Grovemade Logo - at top of page - click to return to homepage"
            baseProfile="tiny"
            x="0px"
            y="0px"
            viewBox="0 0 136.9 11.5"
          >
            <g>
              <path
                fill="#272524"
                d="M23.9,2c0.3-0.3,0.7-0.5,1.1-0.5h0.2c0.4,0,0.8,0.1,1.1,0.3c0.3,0.2,0.5,0.5,0.5,0.8c0,0.3,0.1,0.4,0.3,0.5
			...
			c-0.4,0-0.8-0.2-1.1-0.5c-0.3-0.3-0.5-0.7-0.5-1.1V3.1C23.4,2.7,23.6,2.3,23.9,2z"
              ></path>
              <path
                fill="#272524"
                d="M41.2,5.3c0.2-0.3,0.3-0.6,0.4-0.9c0.1-0.3,0.1-0.7,0.1-1V3.3c0-0.4-0.1-0.9-0.3-1.2
			...
			c0.4,0,0.8,0.2,1.1,0.5c0.3,0.3,0.5,0.7,0.5,1.2V3.4z"
              ></path>
              <path
                fill="#272524"
                d="M53.9,0.9c-0.3-0.3-0.6-0.5-1-0.7C52.5,0.1,52.1,0,51.6,0h-0.1c-0.4,0-0.9,0.1-1.3,0.2
			...
			c0.3-0.3,0.7-0.5,1.1-0.5h0.2c0.4,0,0.8,0.1,1.1,0.4c0.3,0.3,0.5,0.7,0.5,1.1V8.4z"
              ></path>
              <path
                fill="#272524"
                d="M65.3,10.8L67.7,1c0-0.1,0-0.1,0-0.2c0-0.2-0.1-0.4-0.2-0.5C67.3,0.1,67.1,0,66.9,0c-0.2,0-0.3,0-0.4,0.1
			...
			C65.1,11.2,65.2,11.1,65.3,10.8z"
              ></path>
              <path
                fill="#272524"
                d="M75,11.4h5c0.3,0,0.5-0.1,0.6-0.2c0.1-0.2,0.2-0.3,0.2-0.5c0-0.2-0.1-0.4-0.2-0.5c-0.1-0.2-0.3-0.2-0.6-0.2
			...
			c-0.2,0.2-0.2,0.3-0.2,0.5v9.8c0,0.2,0.1,0.4,0.2,0.5C74.6,11.3,74.8,11.4,75,11.4z"
              ></path>
              <path
                fill="#272524"
                d="M94.7,11.3c0.2,0.1,0.3,0.2,0.5,0.2c0.2,0,0.4-0.1,0.5-0.2c0.2-0.1,0.2-0.3,0.2-0.6V0.8
			...
			c0.2-0.1,0.3-0.2,0.3-0.4l1.8-4.1v7C94.5,11,94.6,11.2,94.7,11.3z"
              ></path>
              <path
                fill="#272524"
                d="M107.1,0.1C106.9,0,106.7,0,106.5,0c-0.2,0-0.4,0.1-0.5,0.2c-0.2,0.1-0.3,0.3-0.4,0.5l-3.1,9.9
			...
			l-3.1-9.9C107.4,0.4,107.3,0.2,107.1,0.1z M105.2,7.2l1.3-4.3l1.3,4.3H105.2z"
              ></path>
              <path
                fill="#272524"
                d="M121.6,0.3c-0.4-0.2-0.8-0.2-1.2-0.2h-2.6c-0.2,0-0.4,0.1-0.5,0.2c-0.2,0.2-0.2,0.3-0.2,0.5v9.8
			...
			c0.2,0,0.4,0,0.6,0.1c0.2,0.1,0.4,0.2,0.5,0.4c0.1,0.1,0.3,0.3,0.4,0.5c0.1,0.2,0.1,0.4,0.1,0.6V8.2z"
              ></path>
              <path
                fill="#272524"
                d="M136.1,1.7c0.3,0,0.5-0.1,0.6-0.2c0.1-0.2,0.2-0.3,0.2-0.5v0c0-0.2-0.1-0.4-0.2-0.5
			...
			c0.3,0,0.5-0.1,0.6-0.2c0.1-0.2,0.2-0.3,0.2-0.5c0-0.2-0.1-0.4-0.2-0.5c-0.1-0.2-0.3-0.2-0.6-0.2h-2.9V1.7H136.1z"
              ></path>
              <path
                fill="#272524"
        ...
        <NavLink to='cart' className="font-extrabold text-sm font-urbanist hover-underline" >
          MY CART
        </NavLink>
      </nav>

      {isOpen && <SuperNav mobile={isMobile} hide={() => setIsOpen(false)} />}
    </>
  );
}
