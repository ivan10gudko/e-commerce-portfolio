...
function CheckoutHeader() {
    return (<header className="border-b flex items-center py-5 px-4 md:px-14 lg:px-20 justify-between">
        <div></div>
          <svg
            className="md:w-40 w-32 opacity-80"
          ...
          <Link className='opacity-70 ' to="/shop/shop all">
